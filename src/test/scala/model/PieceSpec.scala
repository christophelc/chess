...
class PieceSpec extends Specification {
  ...
  "A King in a1" should {
    "move to a2 and b1" in {
      ...
      val chessboard = ChessboardImplConfiguration$Piece.emptyChessboard + king
  ...
  "A King in e1 with its rook in h1" should {
    "be able to do small castling" in {
      ...
      generateMoveWithControl(Tools(chessboard, logBook), White)
        .filterKandV(_ == king)(_.isTagged(TagIsControl))
  ...
  "A King in e1 with its rook in h1 but a piece in g1" should {
    "not be able to do small castling" in {
      ...
      val chessboard = ChessboardImplConfiguration$Piece.emptyChessboard + king + rook + knight
      generateMoveWithControl(Tools(chessboard, logBook), White)
        .filterKandV(_ == king)(_.isTagged(TagIsMove))
        .toSeq
  ...
  "A King in e1 with its rook in h1 but a piece in f1" should {
    "not be able to do small castling" in {
      val king = board.KingBoard(White, "e1".toSquare)
      val rook = board.RookBoard(White, "h1".toSquare)
      val knight = BishopBoard(White, "f1".toSquare)
      val chessboard = ChessboardImplConfiguration$Piece.emptyChessboard + king + rook + knight
      generateMoveWithControl(Tools(chessboard, logBook), White)
        .filterKandV(_ == king)(_.isTagged(TagIsMove))
        .existsV(_.dest == "g1".toSquare) should beFalse
  ...
  "A King in e1 with its rook in a1 but a piece in d1" should {
    "not be able to do great castling" in {
      ...
      val chessboard = ChessboardImplConfiguration$Piece.emptyChessboard + king + rook + queen
      generateMoveWithControl(Tools(chessboard, logBook), White)
        .filterKandV(_ == king)(_.isTagged(TagIsMove))
        .toSeq
  ...
  "A Bishop in c2 with 2 pawns" should {
    "move to d1, b3, a4, b1, d3, e4, f5, g6, h7" in {
      val bishop = board.BishopBoard(White, "c2".toSquare)
      val chessboard = ChessboardImplConfiguration$Piece.emptyChessboard + bishop
      generateMoveWithControl(Tools(chessboard, logBook), White)
        .filterV(_.isTagged(TagIsMove))
        .map(_.clearTags)
        .toSeq should
  ...
  "A Bishop in c2" should {
    "move to d1, b3, a4, b1, d3, e4, f5" in {
      ...
      val chessboard = ChessboardImplConfiguration$Piece.emptyChessboard + bishop + pawnG6 + pawnB3
      generateMoveWithControl(Tools(chessboard, logBook), White)
        .filterKandV(_ == bishop)(_.isTagged(TagIsMove))
        .map(_.clearTags)
        .toSeq
  ...
  "A Rook in c2" should {
    "move to a2, b2, c2, d2, e2, f2, c1, c3, c4, c5, c6, c7, c8" in {
      ...
      val chessboard = ChessboardImplConfiguration$Piece.emptyChessboard + rook
      generateMoveWithControl(Tools(chessboard, logBook), White)
        .filterV(_.isTagged(TagIsMove))
        .map(_.clearTags)
        .toSeq should
  ...
  "A Rook in c2 with 2 pawns" should {
    "move to a2, b2, c2, d2, e2, f2, c1, c3, c4, c5, c6, c7, c8" in {
      ...
      val chessboard = ChessboardImplConfiguration$Piece.emptyChessboard + rook + pawnC6 + pawnG2
      generateMoveWithControl(Tools(chessboard, logBook), White)
        .filterKandV(_ == rook)(_.isTagged(TagIsMove))
        .map(_.clearTags)
        .toSeq
        .map(_.dest) should containTheSameElementsAs(
  ...
  "A Queen in c2" should {
    "move to all the directions toward the chessboard" in {
      ...
      val chessboard = ChessboardImplConfiguration$Piece.emptyChessboard + queen
      generateMoveWithControl(Tools(chessboard, logBook), White)
        .filterV(_.isTagged(TagIsMove))
        .map(_.clearTags)
        .toSeq should
  ...
  "A Queen in c2 with 2 pawns" should {
    "move to all the direction twoard the chessboard until the pawns" in {
      ...
      val pawnB3 = board.PawnBoard(Black, "b3".toSquare)
      val chessboard = ChessboardImplConfiguration$Piece.emptyChessboard + queen + pawnC6 + pawnG2 + pawnG6 + pawnB3
      generateMoveWithControl(Tools(chessboard, logBook), White)
        .filterKandV(_ == queen)(_.isTagged(TagIsMove))
        .map(_.clearTags)
  ...
  "A Knight in c2" should {
    "move to a1, a3, b4, d4, e3, e1" in {
      ...
      val chessboard = ChessboardImplConfiguration$Piece.emptyChessboard + knight
      generateMoveWithControl(Tools(chessboard, logBook), White)
        .filterV(_.isTagged(TagIsMove))
        .map(_.clearTags)
        .toSeq should containTheSameElementsAs(
  ...
  "A Knight in c2 with a pawn" should {
    "move to a1, b4, d4, e3, e1" in {
      ...
      val chessboard = ChessboardImplConfiguration$Piece.emptyChessboard + knight + pawnA3
      generateMoveWithControl(Tools(chessboard, logBook), White)
        .filterKandV(_ == knight)(_.isTagged(TagIsMove))
        .map(_.clearTags)
        .toSeq should containTheSameElementsAs(
  ...
  "A white pawn in c2 blocked by a white pawn in c4" should {
    "move to c3" in {
      ...
      val chessboard = ChessboardImplConfiguration$Piece.emptyChessboard + pawn + pawnC4
      generateMoveWithControl(Tools(chessboard, logBook), White)
        .filterKandV(_ == pawn)(_.isTagged(TagIsMove))
        .map(_.clearTags)
        .toSeq should containTheSameElementsAs(
  ...
  "A white pawn in c2 blocked by a black pawn in c3" should {
    "not be able to move" in {
      ...
      val chessboard = ChessboardImplConfiguration$Piece.emptyChessboard + pawn + pawnC3
      generateMoveWithControl(Tools(chessboard, logBook), White)
        .filterKandV(_ == pawn)(_.isTagged(TagIsMove))
        .map(_.clearTags)
  ...
  "A white pawn in c2" should {
    "be able to take a black pawn in b3 or d3" in {
      ...
      val chessboard = ChessboardImplConfiguration$Piece.emptyChessboard + pawn + pawnB3 + pawnC3
      generateMoveWithControl(Tools(chessboard, logBook), White)
        .filterKandV(_ == pawn)(_.isTagged(TagIsMove))
        .map(_.clearTags)
        .toSeq.map(_.dest) should containTheSameElementsAs(
      ...
      generateMoveWithControl(Tools(chessboard, logBook), White)
        ...
        .toSeq should containTheSameElementsAs(
          Seq(
            ...
            Promotion(pawn, board.BishopBoard(White, "c8".toSquare)),
  ...
  "A white pawn in c7" should {
    "not promote if the case c8 is not empty" in {
      ...
      val chessboard = ChessboardImplConfiguration$Piece.emptyChessboard + pawn + pawnC8
      generateMoveWithControl(Tools(chessboard, logBook), White)
        .filterKandV(_ == pawn)(_.isTagged(TagIsMove))
        .map(_.clearTags)
        .toSeq should be empty
  ...
  "A black pawn in c2" should {
    "not promote if the case c1 is not empty" in {
      ...
      val chessboard = ChessboardImplConfiguration$Piece.emptyChessboard + pawnC1
      generateMoveWithControl(Tools(chessboard, logBook), White)
        .filterKandV(_ == pawn)(_.isTagged(TagIsMove))
        .map(_.clearTags)
        .toSeq should be empty
